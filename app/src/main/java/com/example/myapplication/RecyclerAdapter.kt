...
class RecyclerAdapter(private val items: ArrayList<YoutubeItem>) :
    ...
    override fun onBindViewHolder(holder: RecyclerAdapter.ViewHolder, position: Int) {
        ...
        news = arrayOf(
            //헤어
            "‘오늘보다 더 가치있는 내일’을 만들어 드리는 디자이너 혜린입니다! 섬세한 손끝 열정으로 고객님의 아름다움, 영화속의 주인공처럼 고객님의 변신을 위해 끊임없는 노력과 소통으로 함께 동행하는 스타일리스트가 되겠습니다.",
            //모델
            "전신 위주의 감성 프로필촬영에 특화 되어있는 일반인 모델입니다. 웨딩 촬영이나 바디 프로필 사진을 찍고 싶습니다,\n"+"다양한 포즈와 자연스러운 분위기 연출로 촬영에 최선을 다하겠습니다. ",
            //스튜디오
            "자연광에서 자연스럽고 감각적인 촬영이 가능한 하프 스튜디오입니다. 저희 스튜디오는 5곳이 넘는 포토존과 촬영을 위한 다양한 소품 및 오브제를 전부 사용하는 스튜디오입니다.\n"+"따뜻한 공간에서 여러분의 소중한 추억을 남겨보세요!",
            //스튜디오
            "아이들이 촬영하기 편하게끔 뽀로로 테마로 예쁘게 꾸며놓은 스튜디오입니다. 아이들을 최우선으로 다양한 소품과 간식거리를 구비하고 있습니다, 아이들의 가장 사랑스러운 순간을 담아내도록 노력할게요!",
            //사진작가
            "안녕하세요. 한지아 사진작가입니다. 사진촬영은 공장식으로 찍어내기만 하는 방식이 아닌, 본인만의 특별한 매력과 고유한 아름다움을 돋보일 수 있도록 사진의 톤, 포즈, 표정 등 맞춤형으로 촬영합니다. 여러분의 특별한 순간을 기록해보세요!",
            //사진작가
            "안녕하세요, 김상영 사진작가입니다. 개발자의 일을 그만두고 본격적으로 인스타그램 게시물 사진작가 일을 시작했어요. 취미로만 하던 사진을 직업으로 삼게되어 누구보다 책임감을 가지고 예쁜 사진을 찍을 자신이 있습니다",
            //모델
